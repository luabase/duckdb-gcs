...
# PATCH: Remove opentelemetry dependency from storage_grpc config file after fixup
# This is needed because opentelemetry-cpp 1.24.0 is incompatible with google-cloud-cpp 2.37.0
set(_storage_grpc_config "${CURRENT_PACKAGES_DIR}/share/google_cloud_cpp_storage_grpc/google_cloud_cpp_storage_grpc-config.cmake")
if(EXISTS "${_storage_grpc_config}")
    file(READ "${_storage_grpc_config}" _contents)
    string(REPLACE "find_dependency(google_cloud_cpp_opentelemetry)" "# find_dependency(google_cloud_cpp_opentelemetry) # PATCHED: Removed for compatibility" _contents "${_contents}")
    file(WRITE "${_storage_grpc_config}" "${_contents}")
    message(STATUS "Patched ${_storage_grpc_config} to remove opentelemetry dependency")
endif()
